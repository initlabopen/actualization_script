...
rsync -av -e "ssh -p $PORT -i ~/.ssh/id_rsa_ci" "$USER"@"$HOST":"$PATH_DEST/web/sites/default/files/" "$PATH_SOURCE/web/sites/default/files/" --exclude 'settings.php' --exclude 'styles/'
...
sed -i 's/utf8mb4_0900_ai_ci/utf8mb4_unicode_ci/g' $PATH_SOURCE/mysql/db.sql
